      ...
      <div className={`negotiation-steps-sheet ${isOpen ? 'open' : ''}`}>
        <div className="sheet-content">
          ...
          <div className="steps-container">
            ...
            {/* Step 2 - Active with waiting status */}
            <div className="step-item">
              <div className="step-row">
                ...
                <div className="step-content">
                  <div className="step-title active">Libere seus documentos</div>
                  <div className="step-description active">Seus documentos serão enviados para análise da empresa.</div>
            ...
            <div className="step-item">
              <div className="step-row">
                <div className="step-badge inactive">
                  <span>3</span>
                </div>
                <div className="step-content">
                  <div className="step-title">Fechamento do frete</div>
                  <div className="step-description">Faça a coleta e receba o adiantamento no Pix da sua Carteira Fretebras:</div>
                  
                  {/* Pix info */}
                  <div className="pix-info">
                    <div className="pix-key-row">
                      <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.82499 8.94134C7.9626 8.80376 8.20217 8.80333 8.33983 8.94134L10.3008 10.9015C10.6634 11.264 11.1457 11.464 11.6586 11.464H11.8945L9.40467 13.9546L9.25311 14.0906C8.52511 14.6842 7.47478 14.6842 6.74686 14.0906L6.59608 13.9546L4.11248 11.471H4.4992C4.94787 11.471 5.37336 11.3184 5.71561 11.0374L5.85702 10.9093L7.82499 8.94134ZM3.55624 5.08509C3.58789 5.09701 3.62191 5.1054 3.6578 5.1054H4.4992C4.85287 5.10545 5.19929 5.249 5.4492 5.49915L7.41717 7.46712C7.60057 7.65028 7.8418 7.74212 8.0828 7.74212C8.32353 7.74202 8.56426 7.64972 8.74764 7.46634L10.7086 5.50618C10.9273 5.28726 11.2198 5.1503 11.5265 5.11946L11.6586 5.11243H12.343C12.3807 5.11238 12.4162 5.10375 12.4492 5.09055L13.9547 6.59602C14.7298 7.3715 14.7298 8.62834 13.9547 9.40384L12.4492 10.9093C12.4162 10.8961 12.3806 10.8875 12.343 10.8874H11.6586C11.3048 10.8874 10.9585 10.7438 10.7086 10.4937L8.74764 8.53352C8.39233 8.17793 7.77285 8.17822 7.41717 8.53352L5.4492 10.5007C5.19929 10.7508 4.85287 10.8944 4.4992 10.8945H3.6578C3.62191 10.8945 3.58795 10.9029 3.55624 10.9148L2.04608 9.40384C1.31905 8.6768 1.27328 7.52681 1.90936 6.7468L2.04608 6.59602L3.55624 5.08509ZM6.59608 2.04602C7.37157 1.27047 8.62906 1.27047 9.40467 2.04602L11.8945 4.53587H11.6586C11.1457 4.53587 10.6634 4.73588 10.3008 5.09837L8.33983 7.0593C8.19782 7.20151 7.96666 7.20079 7.82499 7.0593L5.85702 5.09134C5.4944 4.72889 5.01197 4.52889 4.4992 4.52884H4.11248L6.59608 2.04602Z" fill="#636B7E"/>
                      </svg>
