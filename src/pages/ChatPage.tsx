                    ...
                    <div className="agreement-review-message">
                      ...
                      <div className="agreement-footer">
                        <div className="verified-info">
                          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.53357 14.0664V5.9331H5.13357V4.3331C5.13357 3.53754 5.41285 2.86088 5.9714 2.3031C6.52985 1.74532 7.2074 1.46643 8.00407 1.46643C8.80063 1.46643 9.4769 1.74532 10.0329 2.3031C10.5889 2.86088 10.8669 3.53754 10.8669 4.3331V5.9331H12.4669V14.0664H3.53357ZM8.00374 11.0331C8.29196 11.0331 8.53568 10.9323 8.7349 10.7308C8.93401 10.5293 9.03357 10.2845 9.03357 9.99626C9.03357 9.70804 8.93279 9.46432 8.73124 9.2651C8.52979 9.06599 8.28496 8.96643 7.99674 8.96643C7.70851 8.96643 7.46479 9.06721 7.26557 9.26876C7.06646 9.47021 6.9669 9.71504 6.9669 10.0033C6.9669 10.2915 7.06768 10.5352 7.26924 10.7344C7.47068 10.9335 7.71551 11.0331 8.00374 11.0331ZM6.00024 5.9331H10.0002V4.3331C10.0002 3.77754 9.80579 3.30532 9.4169 2.91643C9.02801 2.52754 8.55579 2.3331 8.00024 2.3331C7.44468 2.3331 6.97246 2.52754 6.58357 2.91643C6.19468 3.30532 6.00024 3.77754 6.00024 4.3331V5.9331Z" fill="#BABEC9"/>
                          </svg>
                          <span className="verified-text">Verificado por Fretebras</span>
                        </div>
                        <span className="timestamp">{msg.timestamp}</span>
                      </div>
                    </div>
